...
export default function MapEmptyState({
  myNight, hasUnmappedEvents, timeError, onClear, onReset, onBrowse, onShowList,
}: {
  myNight: boolean;
  ...
  return (
    <section className="map-empty" aria-label="No map results">
      <div className="map-empty-content">
        ...
        <h2>
          {hasUnmappedEvents ? "No map locations available" : myNight ? "No saved events yet" : timeError ? "Check your availability" : "No matching events"}
        </h2>
        <p>
